...
const FAQ = () => {
    ...
    <h1 className="bold grey_big">Faq</h1>
    <article className="faq__article">
        <p className="big__text">Here at Hi-Fi Corner, our trained product specialists aim to provide the right product for you.
        We take great care with all of our orders to ensure you are fully happy with the product.</p>

        <p className="zero--margin">We aim to resolve any problems to your satisfaction.</p>
        <p className="zero--margin">Please contact us directly, if, for any reason, you have an issue with your order, your product or any other service provided. OUR GUARANTEE</p>
        <p className="zero--margin">All items excluding ex-display and secondhand goods are covered by at least 12 months warranty; this is detailed on your receipt. Any secondhand or ex-display product is covered by at least 3 months warranty as noted in the original listing.</p>
        <p className="zero--margin">Hi-Fi Corner cannot guarantee against any misuse (i.e. blown speakers etc.), commercial use, wear and tear, erosion of parts, loss of data stored on any form of writeable/hard drive devices, dead pixels of an amount not covered by the manufacturer’s specifications or where you have not allowed repairs of goods to be carried out by authorised agents. If it has been more than 30 days since you have received a product and discovered a fault, we will still repair the goods free of charge or, if you prefer, replace them provided that you report the fault within 12 months of purchase. If we are unable to repair or replace the item(s) we will provide you with a full refund instead.</p>
        ...
        <h1 className="bold">Sale items</h1>
        ...
        <h1 className="bold">Exchanges</h1>
        ...
        <p>Hi-Fi Corner, 2 Joppa Road, Mackenzie House, Portobello, Edinburgh, EH15 2EU.</p>
        <p>Please also include the proof of purchase and a cover letter detailing the reason for exchange.</p>
