    ...
    return (
        <>
            ...
            <header className="page-header">
                <h1 className="page-header__title" id="privacy">FAQ</h1>
            </header>

            <article className="page-content whitebox">

                <h1 className="title">Here at Hi-Fi Corner, our trained product specialists aim to provide the right product for you.<br/>
                We take great care with all of our orders to ensure you are fully happy with the product.</h1>

                <p>We aim to resolve any problems to your satisfaction.<br/>
                Please contact us directly, if, for any reason, you have an issue with your order, your product or any other service provided. OUR GUARANTEE<br/>
                All items excluding ex-display and secondhand goods are covered by at least 12 months warranty; this is detailed on your receipt. Any secondhand or ex-display product is covered by at least 3 months warranty as noted in the original listing.<br/>
                ...
                <h2 className="subhead" id="refunds">Refunds</h2>
                ...
                <h2 className="subhead" id="delivery">Delivery</h2>
                ...
                <h2 className="subhead" id="termsConditions">Returns process/your statutory rights</h2>
