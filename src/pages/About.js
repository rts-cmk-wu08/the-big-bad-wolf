    ...
    return (
        ...
        <article class="item">
            <section class="item__info">
                <b><h5>History</h5></b>
                <b><p class="p-col">Established in the late 1960s, our family owned business is based in Edinburgh and Falkirk, but services customers across the UK. </p></b>
            ...
            <section class="item__img"><img src="1.jpg" height="275" width="450"/></section>
        </article>
        <article class="item">
            <section class="item__info">
                <b><h5>Hear The Difference</h5></b>
                <b> <p class="p-col">Book a demonstration at our Edinburgh or Falkirk showrooms.   </p></b>
            ...
            <section class="item__img"><img src="2.jpg" height="275" width="450"/></section>
        </article>
        <article class="item">
            <section class="item__info">
                <b>  <h5>Services</h5></b>
                <b><p class="p-col">Our passion for the products we sell and, for our customers’ satisfaction simply means that we happily offer additional services not found on the high-street. </p></b>

                <p>Home Setup - We want to ensure that the equipment you’ve purchased from us is installed correctly and sounds perfect; and we happily provide this service throughout the UK.
            ...
            <section class="item__img"><img src="3.jpg" height="275" width="450"/></section>
        </article>
        <article class="item">
            <section class="item__info">
                <b><h5>Tailored For You</h5></b>
                <b><p class="p-col">We look forward to customising a system to meet your needs.  </p></b>

                <p>We don’t favour one manufacturer over another – the only thing we do favour is making sure our customers get the right product that suits their needs and listening preferences. We will ask many questions in order to ensure that what you buy from us is tailored to you and you alone. 
            ...
            <section class="item__img"><img src="4.jpg" height="275" width="450"/></section>
        </article>
